...
class TestAdjustAndSaveForecast:
    ...
    def test_adjust_and_save_writes_adjusted_model(self, db_session, sites, forecasts, generation_db_values):
...
class TestSaveForecast:
    ...
    def test_save_forecast_adjuster_skipped_when_model_name_none(self, db_session, sites):
        """When ml_model_name is None, adjuster path is skipped even if use_adjuster_database=True."""
        ...
        df = pd.DataFrame(
            {
                ...
                "probabilistic_values": [{"p10": 400.0, "p90": 600.0}, {"p10": 800.0, "p90": 1200.0}],
            }
        )
